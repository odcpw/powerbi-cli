...
const FEATURE_CATALOG: &[Feature] = &[
    ...
    Feature {
        ...
        refusal_code: None,
        reason: "Theme, visual formatting, master-style bundles, and the deterministic versioned design-token catalog preserve raw PBIR cards while guarding literal text, contrast, and typed color/text patches.",
