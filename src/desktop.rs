...
#[cfg(test)]
use observe::{render_process_snapshot_script, render_window_query_script};
...
#[cfg(test)]
use evidence::render_screenshot_script;
#[cfg(windows)]
use evidence::{
...
#[cfg(any(windows, test))]
use evidence::{screenshot_changes, screenshot_observation_is_eligible};
...
mod tests {
    use super::{
        DesktopOperation, PreflightMode, ProcessIdentity, cleanup_unresolved_after_launch,
        desktop_argument_path, detect_power_bi_desktop, ensure_desktop_platform,
        parse_desktop_args, powershell_single_quoted, remaining_budget, render_cleanup_script,
        render_launch_script, render_process_identity_script, render_process_snapshot_script,
