...
const FEATURE_CATALOG: &[Feature] = &[
    ...
    Feature {
        ...
        refusal_code: None,
        reason: "The CLI writes a one-column same-report pageBinding parameter with boundFilter + fieldExpr and a paired bodyless Categorical Drillthrough filter, matching the Desktop-authored microsoft/BCApps reference shape. A manual Desktop canvas/refresh session (2026-07-10, Desktop Store 2.155.756.0) verified the registered drillthrough well, level-correct context menu, target-page navigation, and carried filters working end to end; the evidence record is retained in a private repository. Cross-report drillthrough, visual action links, measures, and field parameters remain explicitly refused.",
        next_proof: &[
        ...
        reference_signals: &[
            "manual Desktop canvas/refresh session (2026-07-10, Desktop Store 2.155.756.0): same-report drillthrough verified end to end; evidence record retained in a private repository",
    ...
    Feature {
        ...
        category: "report",
        status: "supported",
        support: "generated-clean-state-manual-desktop-canvas-refresh",
        proof_level: "manual-desktop-canvas-refresh",
        emits_pbir: true,
        commands: &[
            "report visuals catalog",
