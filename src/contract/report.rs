...
pub(super) fn commands() -> Vec<Value> {
    vec![
        ...
        json!({
            ...
            "flags": ["--schema <schema.json>", "--profile <profile.json>", "--project <project-dir-or.pbip>", "--intent <intent.md|intent.json|text>", "--objective <goal>", "--out <dashboard.json>", "--force", "--explain-rules", "--json", "--format json"],
            "examples": [
