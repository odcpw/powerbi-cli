...
mod tests {
    use super::{
        DesktopOperation, PreflightMode, ProcessIdentity, ScreenshotCaptureResult,
        ...
        parse_desktop_args, path_is_within_directory, powershell_single_quoted, publish_screenshot,
        remaining_budget, render_cleanup_script, render_launch_script,
        render_process_identity_script, render_process_snapshot_script, render_screenshot_script,
