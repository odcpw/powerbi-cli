...
pub(super) fn commands() -> Vec<Value> {
    vec![
        json!({
            ...
            "styleCompilation": "style.preset compiles to ApplyThemePreset and style.bundle to ApplyStyleBundle at the final operation stage. Literal-text bundles require style.allowLiteralText:true. style.defaults and non-typography style.tokens remain unsupported under pbi-t3-compiler-completeness-1qi.13.",
